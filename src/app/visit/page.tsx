  ...
  return (<div>
    ...
    <Sections>
      ...
      <section id="accessibility">
        <h2>Accessibility</h2>
        <p>MathsWorld is committed to being accessible to all visitors and we are continually developing in this aspect:</p>
        <ul>
          <li>Wheelchair accessible entrances and exhibits</li>
          <li>Accessible restrooms throughout the facility</li>
          <li>Ear defenders for visitors with sensory sensitivities</li>
        </ul>
