export default function Visit() {
  return (
    <div>
      <title>MathsWorld London – Website Terms</title>
      <h1>Website Terms and Conditions</h1>
      <p>
        These terms and conditions govern your use of the MathsWorld website; by using this website,
      ...
      <p>
        Unless otherwise stated, MathsWorld owns the intellectual property rights of the website and
        material on the website. Subject to the license below, all these intellectual property
        rights are reserved.
      </p>
      <p>
      ...
      <ul>
        <li>
          republish material from this website (including republication on another website) without
          stating MathsWorld as the source;
        </li>
      ...
      <p>
        ...
        relation to, this website without MathsWorldUK’s express written consent.
      </p>
      <p>
        You must not use this website to transmit or send unsolicited commercial communications.
      </p>
      <p>
        You must not use this website for any purposes related to marketing without MathsWorldUK’s
      ...
      <p>
        You grant to MathsWorld a worldwide, irrevocable, non-exclusive, royalty-free license to
        use, reproduce, adapt, publish, translate and distribute your user content in any existing
        or future media.
      </p>
      <p>
        ...
        MathsWorld or a third party (in each case under any applicable law).
      </p>
      <p>
        You must not submit any user content to the website that is, or has ever been, the subject
        of any threatened or actual legal proceedings or other similar complaint.
      </p>
      <p>
        MathsWorld reserves the right to edit or remove any material submitted to this website, or
        stored on MathsWorld servers, or hosted or published upon this website.
      </p>

      <h2>No warranties</h2>
      <p>
        This website is provided ‘as is’ without any representations or warranties, express or
        implied. MathsWorld makes no representations or warranties in relation to this website or
        the information and materials provided on this website.
      </p>
      <p>
        Without prejudice to the generality of the foregoing paragraph, MathsWorld does not warrant
        that:
      </p>
      <ul>
      ...
      <p>
        MathsWorld will not be liable to you (whether under the law of contract, the law of torts or
      ...
      <p>
        These limitations of liability apply even if MathsWorld has been expressly advised of the
        potential loss.
      </p>
      ...
      <p>
        ...
        or limit MathsWorld liability in respect of any:
      </p>
      <ul>
        <li>death or personal injury caused by MathsWorld negligence;</li>
        <li>fraud or fraudulent misrepresentation on the part of MathsWorld; or</li>
        <li>
          matter which it would be illegal or unlawful for MathsWorld to exclude or limit, or to
      ...
      <p>
        ...
        this website disclaimer are reasonable. If you do not think they are reasonable, you must
        not use this website.
      </p>
      <h2>Unenforceable provisions</h2>
      <p>
        If any provision of this website disclaimer is, or is found to be, unenforceable under
        applicable law, this will not affect the enforceability of the other provisions of this
        website disclaimer.
      </p>
      <h2>Variations</h2>
      <p>
        MathsWorld may revise these terms and conditions from time to time. Revised terms and
      ...
      <p>
        <em>These terms and conditions are effective from 1 August 2021</em>
      </p>
    </div>
  );
}
